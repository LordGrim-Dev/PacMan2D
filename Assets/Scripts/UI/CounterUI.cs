...
namespace PacMan.UI
{
    public class CounterUI : BaseUI
    {
        ...
        private void OnEnable()
        {
            ...
            if (m_CounterCountDown != null)
                StopCoroutine(m_CounterCountDown);

            m_CounterCountDown = StartCoroutine(StartCounter());
        }
        ...
        private IEnumerator StartCounter()
        {
            ...
            while (true)
            {
                ...
                {
                    PMUIManager.Instance().OnCounterZero();
